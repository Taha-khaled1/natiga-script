...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">المعاهد /</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">جميع
                    المعاهد</span>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-3">
                        <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale"
                            data-toggle="modal" href="#modaldemo8">اضافة معهد</a>
                    </div>
                        ...
                        <table class="table text-md-nowrap" id="example1">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0">اسم المعهد</th>
                                    <th class="wd-20p border-bottom-0">بتوقيت</th>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">اضافة معهد</h6><button aria-label="Close" class="close"
                    ...
                    <div class="modal-body">
                        <form action="{{ route('coupons.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">اسم المعهد</label>
                    ...
                    <div class="modal-body">
                        <form action="{{ route('coupons.update') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-lg">
                                ...
                                <input class="form-control" placeholder="الكود"type="text" name="name" id="name"
                                    value="">
                            </div>
                            ...
                            <div class="col-lg">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input aria-label="Amount (to the nearest dollar)" class="form-control"
                                        placeholder="السعر" type="number" name="region" min="1" id="region"
                                        required>
                            ...
                            <div class="col-lg">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" id="datetimepicker2" type="text" name="city"
                                        value="">
                                </div>
                            </div>
                            <div class="col-lg">
